...
const PricingCard = () => {
    return (
        <div className="h-screen">
            <Navbar />
            <section className="mt-8 md:h-[80vh] flex justify-center items-center">
                <div>
                    <div>
                        <p className="text-4xl font-medium text-center mt-5">
                            One Stop Business Solution
                        </p>
                        <p className="text-lg mt-2 text-gray-400 text-center mb-5">
                            Adjustable for any business. <br /> Accessible from
                            any of your favorite devices and any of your
                            favorite places.
                        </p>
                    </div>
                    <div className="flex justify-center gap-5">
                        <div>
                            <div class="shadow-lg rounded-2xl w-64 bg-gradient-to-r bg-white p-4">
                                ...
                                <button
                                    type="button"
                                    class="w-full px-3 py-3 text-sm shadow rounded-lg text-white bg-cyan-500 "
                                >
                                    Choose plan
                                </button>
                            </div>
                        ...
                        <div>
                            <div class="shadow-lg rounded-2xl w-64 bg-cyan-500 p-4">
