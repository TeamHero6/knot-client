        ...
        <div>
            ...
            <div className="py-20 2xl:px-0 lg:px-12 px-4 2xl:mx-auto 2xl:container bg-gray-50" >
                <div className="md:flex items-center justify-between w-full bg-gray-50">
                    <div className="xl:w-1/3 md:w-1/2 w-full pl-16">
                        <h1 role="heading" className="focus:outline-none md:w-60 font-bold md:text-6xl text-4xl leading-tight text-gray-800">
                            Get <span className="font-normal italic"> in touch </span>
                        </h1>
                        <p role="contentinfo" className="focus:outline-none text-base leading-6 mt-8 text-gray-600 2xl:pr-24 xl:pr-0 pr-12">
                            Knot, your friendly automated chat assistant is here to assist you 24 hours a day. </p> <br />
                        <p role="contentinfo" className="focus:outline-none text-base leading-6 mt-8 text-gray-600 2xl:pr-24 xl:pr-0 pr-12">
                            Knot, your friendly automated chat assistant is here to assist you 24 hours a day. </p> 
                            Call us everyday or everyday from 9:00 AM – 6:00 PM
                        <div className="mt-10">
                            <button className="flex items-center md:p-3 p-1 focus:outline-none text-xl font-medium leading-5 text-gray-800 focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 text-blue-500">
                                Discover more
                    ...
                    <div className="xl:w-4/6 md:w-1/2 w-full xl:pl-48">
                        <div className="w-full">
                            <div className="flex items-center ">
                                ...
                                Mirpur - 1207, Dhaka Division, Bangladesh
                                </p>
                            </div>
