...
const Attendance = () => {
    ...
    return (
        <div>
                    ...
                    <table class="shadow-2xl border-2 border-cyan-300 min-w-1/2 mx-auto my-12 text-base overflow-hidden">
                        <thead className='text-white bg-cyan-500 border-b border-cyan-100'>
                            <tr>
                                ...
                                <th className="py-3 text-left px-6 whitespace-nowrap">Over Time</th>
                                <th className="py-3 text-left px-6 whitespace-nowrap">Employee Details</th>
                        ...
                        <tbody>
                            <tr  className='hover:shadow-md hover:bg-cyan-100 hover:scale-105 duration-500 cursor-pointer border-b border-cyan-100'>
                                ...
                                <td className="py-3 px-6 whitespace-nowrap">Sales</td>
                                <td className="py-3 px-6 whitespace-nowrap">Sales</td>
                                <td className="py-3 px-6 whitespace-nowrap">Sales</td>
            ...
            <h3 className='text-[#0182be] text-2xl p-5'>Employees Attendnace Action</h3>
