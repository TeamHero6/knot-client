                ...
                show ? <div className=''>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <section className='lg:w-10/12 mx-auto bg-white shadow-gray-300 border shadow-md rounded py-12 px-5 mt-10 md:w-9/12 sm:w-11/12 sm:mx-auto'>
                            ...
                            <div className='flex flex-row gap-5'>
                                <input className='py-2 pl-3 w-6/12 my-1 border border-gray-300 bg-slate-50 rounded outline-none ' type="text" {...register("Promoted_Designation")} id="" placeholder='Promoted Designation' />
                            ...
                            <div className='flex flex-row gap-5'>
                                <input className='py-2 pl-3 w-6/12 my-1 border border-gray-300 bg-slate-50 rounded outline-none ' type="text" {...register("Incriment_Salary")} id="" placeholder='Incriment Salary' />
                                <input className='py-2 pl-3 w-6/12 my-1 border border-gray-300 bg-slate-50 rounded outline-none ' type="date"  {...register("Pormotion_Date")} id="" placeholder='Pormotion_Date' />
                            </div>
                            ...
                            <div className='flex flex-row gap-5'>
                                ...
                                <select className='w-6/12 pl-3 py-2 border border-gray-300 bg-slate-50 rounded outline-none' {...register("Promoted_Type")}>
                                ...
                                promo.map(pr =>
                                    <tr className='hover:shadow-md hover:bg-cyan-100 hover:scale-105 duration-500 cursor-pointer border-b border-cyan-100'>
                                        ...
                                        <td className='text-[#0182be]'>
                                            <label for={pr._id} onClick={()=>setmodal(pr)} class="modal-button">
                        ...
                        <div class="modal-box">
                            <div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <p><span className='font-medium capitalize'> Employee ID: </span>{modal.Employee_ID}</p>
                                        <p><span className='font-medium capitalize'>Incriment Salary: </span>{modal.Incriment_Salary}</p>
                                        <p><span className='font-medium capitalize'>Designation: </span>{modal.Designation}</p>
                                        <p><span className='font-medium capitalize'>Pormotion Date: </span>{modal.Pormotion_Date}</p>
