    ...
    return (
        <div className='md:mx-16 lg:mx-36 mb-12'>
            ...
            <div className='flex justify-center flex-wrap gap-20'>
                ...
                <section>
                    <h1 className='font-bold text-center mb-4'>Finance Tracking Tool</h1>
                ...
                {/*------- Sales Management --------*/}
                <section>
                    <h1 className='font-bold text-center mb-4'>Sales Management</h1>
                    <div className='flex justify-center'>
                        <div>
                ...
                <section>
                    <h1 className='font-bold text-center mb-4'>Marketing Automation</h1>
                    <div className='flex justify-center'>
                        <div>
                ...
                {/*------- Live Chatting --------*/}
                <section>
                    <h1 className='font-bold text-center mb-4'>Live Chatting</h1>
                    <div className='flex justify-center'>
                        <div>
                ...
                {/*------- Task Management --------*/}
                <section>
                    <h1 className='font-bold text-center mb-4'>Task Management</h1>
                    <div className='flex justify-center'>
                        <div>
