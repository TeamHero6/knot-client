...
const HRCircularCard = (props) => {
    ...
    return (
        <div className='bg-white  shadow-gray-300 px-5 py-5 rounded-md shadow-sm hover:shadow-md hover:bg-cyan-100 hover:scale-105 duration-500 cursor-pointer border-b border-cyan-100'>
