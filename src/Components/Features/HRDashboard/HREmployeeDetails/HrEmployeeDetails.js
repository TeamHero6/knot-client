             ...
             <div>
                    ...
                    >
                        ...
                        <div className="mt-5">
                            {show ? (
                                <div>
                                <form onSubmit={handleSubmit(onSubmit)} style={{ width: "1000px" }}>
                                ...
                                <h2 className="text-blue-900 my-3 text-xl font-medium">Employee Details</h2>
                                    ...
                                    <h2 className="text-blue-900 my-3 text-xl font-medium">Emergency Contact</h2>
                                    <div className="flex flex-row gap-5">
                                        <input
                                            className="py-2 pl-3 w-full my-1 border border-gray-300 bg-slate-50 rounded outline-none "
                                            type="text"
