                    ...
                    <table class="shadow-2xl border-2 border-cyan-300 min-w-1/2 mx-auto text-base overflow-hidden">
                        <thead className='text-white bg-cyan-500 border-b border-cyan-100'>
                            <tr>
                                ...
                                <th className="py-3 text-left px-6 whitespace-nowrap">E-MAIL</th>
                            </tr>
                        </thead>
                        <tbody>
                            {
                                newsletterMail?.map((mail, index) => <tr key={mail._id} className='hover:shadow-md hover:bg-cyan-100 hover:scale-105 duration-500 cursor-pointer border-b border-cyan-100'>
                                    <th className="py-3 px-6 whitespace-nowrap">{index + 1}</th>
                                    <td className="py-3 px-6 whitespace-nowrap">{mail.email}</td>
                                </tr>)
                            }
