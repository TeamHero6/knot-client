                ...
                <div class="overflow-auto rounded-none mx-auto">
                    <table class="shadow-2xl border-2 border-cyan-300 mx-auto my-12 text-base overflow-hidden">
                        <thead className='text-white bg-cyan-500 border-b border-cyan-100'>
                            ...
                            <tr>
                                <th className="py-3 text-left px-3 pl-10 whitespace-nowrap">Product</th>
                                <th className="py-3 text-left px-3 whitespace-nowrap">Purchase Amount</th>
                                <th className="py-3 text-left px-3 whitespace-nowrap">Sales Amount</th>
                                <th className="py-3 text-left px-3 whitespace-nowrap">Vendor</th>
                                <th className="py-3 text-left px-3 pr-10 whitespace-nowrap">Details</th>
                            </tr>
                        </thead>
                        <tbody>
                            {
                                itemList.slice(0, 5).map(item => <tr key={item._id}
                                    className='hover:shadow-md hover:bg-cyan-100 hover:scale-105 duration-500 cursor-pointer border-b border-cyan-100'>
                                    <td className="py-3 px-1 pl-10 whitespace-nowrap">{item.productName}</td>
                                    <td className="py-3 px-3 whitespace-nowrap text-center">{item.purchaseAmount} $</td>
                                    <td className="py-3 px-3 whitespace-nowrap text-center">{item.salesAmountValue
                                    } $</td>
                                    <td className="py-3 px-3 whitespace-nowrap">{item.vendorName}</td>
