        ...
        <div>
            <div className='grid grid-cols-3 gap-4'>
                <div class="card col-span-1 mx-auto card-compact w-72 bg-base-100 shadow-xl">
                    <div class="card-body text-center">
                        <h2 className='font-bold text-2xl text-red-500'>$500</h2>
            ...
            <div className='lg:w-full mx-20 flex justify-around bg-white shadow-gray-300 border shadow-md rounded py-6 px-6 mt-5 md:w-9/12 sm:w-11/12 sm:mx-auto'>
                <div>
                    ...
                    <hr className='mt-2'/>
                    <br />
                    <p className='font-semibold'>Total Expense: <span className='font-sans text-red-500'>$500</span> </p>
                </div>
                <div>
            ...
            <div className='lg:w-full mx-20 mb-5 flex justify-around bg-white shadow-gray-300 border shadow-md rounded py-6 px-6 mt-5 md:w-9/12 sm:w-11/12 sm:mx-auto'>
                <div>
                    <PieChart width={350} height={250}>
                        ...
                        <Pie data={data02} dataKey="value" nameKey="name" cx="50%" cy="50%" innerRadius={60} outerRadius={80} fill="#009FFF" label />
                    </PieChart>
                    <p className='text-center text-red-500 font-bold'>Direct Expense</p>
                </div>
                <div>
                    <PieChart width={350} height={250}>
                        <Pie data={data01} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={50} fill="#009FFF" />
                        <Pie data={data02} dataKey="value" nameKey="name" cx="50%" cy="50%" innerRadius={60} outerRadius={80} fill="#82ca9d" label />
                    </PieChart>
                    <p className='text-center text-red-500 font-bold'>General & Admin Expense</p>
                </div>
                <div>
                    <PieChart width={350} height={250}>
                        <Pie data={data01} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={50} fill="#B84772" />
                        <Pie data={data02} dataKey="value" nameKey="name" cx="50%" cy="50%" innerRadius={60} outerRadius={80} fill="#82ca9d" label />
                    </PieChart>
                    <p className='text-center text-red-500 font-bold'>Salary Expense</p>
                </div>
            </div>
        </div>
    );
